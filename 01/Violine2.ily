\relative {
  ...
  h8-! as'([ g f)] h8. as16 g8. g16
  f8. f16 f8. f16 h,4 r
  r8 h'( as g) r as( g f) %20
  ...
  r f( es d) es2~
  es4 d8 c d d([\pp c h)]
  r c( h a) c4.-\fftenuto c8 %35
  d4~ d~\p d2-\pptenuto\fermata \bar "|." %36 finis
}
